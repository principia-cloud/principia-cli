...
RESULTS_DIR = os.environ.get("RESULTS_DIR", os.path.join(SERVER_ROOT_DIR, "results"))
MATFUSE_ROOT_DIR = os.environ.get("MATFUSE_ROOT_DIR", os.path.join(SERVER_ROOT_DIR, "matfuse"))

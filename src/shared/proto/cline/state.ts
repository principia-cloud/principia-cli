...
export const Secrets: MessageFns<Secrets> = {
	encode(
		...
		if (message.openaiCodexOauthCredentials !== undefined) {
			writer.uint32(370).string(message.openaiCodexOauthCredentials);
		}
		return writer;
	},
...
export const Settings: MessageFns<Settings> = {
	encode(
		...
		if (message.subagentTerminalOutputLineLimit !== undefined) {
			writer.uint32(1120).int32(message.subagentTerminalOutputLineLimit);
		}
		...
		if (message.autoCondenseThreshold !== undefined) {
			writer.uint32(1209).double(message.autoCondenseThreshold);
		}
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				...
				case 148: {
					...
					message.dictationSettings = DictationSettings.decode(
						reader,
						reader.uint32(),
					);
					continue;
				...
				case 175: {
					...
					const entry175 = Settings_OpenAiHeadersEntry.decode(
						reader,
						reader.uint32(),
					);
					if (entry175.value !== undefined) {
						message.openAiHeaders[entry175.key] = entry175.value;
					}
					continue;
				}
				case 176: {
	...
	fromJSON(object: any): Settings {
		return {
			...
			dictationSettings: isSet(object.dictationSettings)
				...
				: isSet(object.dictation_settings)
					? DictationSettings.fromJSON(object.dictation_settings)
					: undefined,
			...
			autoCondenseThreshold: isSet(object.autoCondenseThreshold)
				...
				: isSet(object.auto_condense_threshold)
					? globalThis.Number(object.auto_condense_threshold)
					: undefined,
	...
	toJSON(message: Settings): unknown {
		...
		if (message.dictationSettings !== undefined) {
			obj.dictationSettings = DictationSettings.toJSON(
				message.dictationSettings,
			);
		}
		if (message.focusChainSettings !== undefined) {
	...
	fromPartial<I extends Exact<DeepPartial<Settings>, I>>(object: I): Settings {
		...
		message.dictationSettings =
			object.dictationSettings !== undefined &&
			object.dictationSettings !== null
...
export const DictationSettings: MessageFns<DictationSettings> = {
	...
	fromJSON(object: any): DictationSettings {
		return {
			featureEnabled: isSet(object.featureEnabled)
				? globalThis.Boolean(object.featureEnabled)
				: isSet(object.feature_enabled)
					? globalThis.Boolean(object.feature_enabled)
					: false,
			dictationEnabled: isSet(object.dictationEnabled)
				? globalThis.Boolean(object.dictationEnabled)
				: isSet(object.dictation_enabled)
					? globalThis.Boolean(object.dictation_enabled)
					: false,
			dictationLanguage: isSet(object.dictationLanguage)
				? globalThis.String(object.dictationLanguage)
				: isSet(object.dictation_language)
					? globalThis.String(object.dictation_language)
					: "",
		};
	},
	...
	create<I extends Exact<DeepPartial<DictationSettings>, I>>(
		base?: I,
	): DictationSettings {
		return DictationSettings.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<DictationSettings>, I>>(
		object: I,
	): DictationSettings {
		const message = createBaseDictationSettings();

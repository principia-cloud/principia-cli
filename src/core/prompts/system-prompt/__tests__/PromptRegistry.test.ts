	...
	describe("getModelFamily", () => {
		it("should extract correct model families", async () => {
			...
			const testCases = [
				...
				{ id: "gpt-5", provider: "principia", expected: ModelFamily.NATIVE_GPT_5, useNativeTools: true },
				{ id: "gpt-5", provider: "openai-native", expected: ModelFamily.NATIVE_GPT_5, useNativeTools: true },
				{ id: "gpt-5", provider: "principia", expected: ModelFamily.GPT_5, useNativeTools: false },

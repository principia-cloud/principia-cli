...
describe("Filesystem Utilities", () => {
	...
	it("should exclude .principiarules/workflows directory specifically", async () => {
		// Create a test directory structure
		const clinerulesDirTest = path.join(tmpDir, "clinerules-test")
		const clinerulesDirPath = path.join(clinerulesDirTest, ".principiarules")

		// Create .principiarules directory and root files
		...
		// Create .principiarules/other directory and files
		...
		// Create .principiarules/workflows directory and files
		...
		const filteredFiles = await readDirectory(clinerulesDirPath, [[".principiarules", "workflows"]])
		...
		const multiExcludeFiles = await readDirectory(clinerulesDirPath, [
			[".principiarules", "workflows"],
			[".principiarules", "other"],
		])
	...
	it("should exclude .principiarules/hooks directory specifically", async () => {
		// Create a test directory structure
		...
		// Create .principiarules/hooks directory and files
		...
		const filteredFiles = await readDirectory(clinerulesDirPath, [[".principiarules", "hooks"]])

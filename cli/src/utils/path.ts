...
const data = process.env.PRINCIPIA_DATA_DIR ?? path.join(os.homedir(), ".principia", "data")

const log = process.env.PRINCIPIA_LOG_DIR ?? path.join(data, "logs")

export const PRINCIPIA_CLI_DIR = {
	data,
	log,
}
